...
public class KapustaBlock extends Szkolna17ModElements.ModElement {
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(LiscKapustyItem.block, (int) (2)));
		}
