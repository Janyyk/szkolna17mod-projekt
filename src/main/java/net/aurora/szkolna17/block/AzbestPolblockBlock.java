...
public class AzbestPolblockBlock extends Szkolna17ModElements.ModElement {
	@ObjectHolder("szkolna17:azbest_polblock")
	public static final Block block = null;
	public AzbestPolblockBlock(Szkolna17ModElements instance) {
		super(instance, 19);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(15f, 1200f).lightValue(0));
			setRegistryName("azbest_polblock");
		}
