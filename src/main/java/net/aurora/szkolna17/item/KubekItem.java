...
import net.aurora.szkolna17.procedures.KubekBulletHitsBlockProcedure;
...
public class KubekItem extends Szkolna17ModElements.ModElement {
	@ObjectHolder("szkolna17:kubek")
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletkubek").setRegistryName("entitybulletkubek"));
	}
	...
	public static class ItemRanged extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Ten kubek zaraz wyl\u0105duje na twojej g\u0142owie!"));
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(KubekItem.block, (int) (1));
		}
			...
			if (this.inGround) {
				{
					...
					KubekBulletHitsBlockProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
