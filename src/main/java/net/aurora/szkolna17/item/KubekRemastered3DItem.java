...
public class KubekRemastered3DItem extends Szkolna17ModElements.ModElement {
	@ObjectHolder("szkolna17:kubek_remastered_3_d")
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletkubek_remastered_3_d").setRegistryName("entitybulletkubek_remastered_3_d"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(Szkolna17ModItemGroup.tab).maxDamage(100));
			setRegistryName("kubek_remastered_3_d");
		}
